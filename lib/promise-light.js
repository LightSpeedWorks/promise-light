...
this.PromiseLight = function () {
  ...
  setValue(Promise.prototype, 'then', then);
  ...
  // catch(rejected)
  setValue(Promise.prototype, 'catch', caught);
  ...
  // $$fire
  setValue(Promise.prototype, '$fire', $$fire);
  function $$fire() {
    var $this = this;
    var elem;
  ...
  setValue(Promise.prototype, '$checkUnhandledRejection', $$checkUnhandledRejection);
